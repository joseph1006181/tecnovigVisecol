...
Future<dynamic> consultaCorrespondencia(String idResidenteCorrespondencia)async{


       
   var url = Uri.parse(
 // "https://widgets-z3fldjynra-uc.a.run.app/buscarCorrespondencia?idResidenteCorrespondencia=$idResidenteCorrespondencia"
   "https://clientes.tecnovig.com/consultas/api_correspondencia.php?idResidenteCorrespondencia=$idResidenteCorrespondencia"
   // Visita_URL,
...
try {
     ...
     List<CorrespondenciaModel> listCorrespondencia = []; // si hay datos los convertimos a lista tipo visistas   
